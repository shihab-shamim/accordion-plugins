	...
	return <>
		<InspectorControls>
			...
			>
				{
					tab => <>
						{'general' === tab.name && <General selected={selected} attributes={attributes} setAttributes={setAttributes} />}

						{'style' === tab.name && <Style selected={selected} attributes={attributes} setAttributes={setAttributes} />}
					</>
				}
			</TabPanel>
		</InspectorControls>
